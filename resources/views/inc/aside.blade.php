...
<div class="sidenav-header">
  ...
  <a class="navbar-brand m-0" href="{{route('home')}}">
    <img src="{{ asset('front/img/logo-ct-dark.png') }}" class="navbar-brand-img h-100" alt="main_logo">
    <span class="ms-1 font-weight-bold">SOCIALME</span>
  </a>
</div>
...
<div class="collapse " id="dashboardsExamples">
  <ul class="nav ms-4 ps-3">
    ...
    <li class="nav-item ">
      ...
      <a class="nav-link " href="{{asset('dashboard/default.html')}}">
